...
## 2026-07-26 - Eager imports block initial load
**Learning:** Eager imports of route views containing heavy SDKs (like Agora in VoiceRoomView) bundle everything into a massive main JS file, significantly blocking initial app load.
**Action:** Always use React.lazy() and Suspense for route-level code splitting to defer loading heavy dependencies until the user actually navigates to that route.
