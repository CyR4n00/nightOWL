...
// Code-split the VoiceRoomView since it heavily depends on Agora SDK, reducing the initial bundle size
    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden pb-24">
      ...
      <div className="flex-1 relative z-10 w-full max-w-lg mx-auto">
        ...
        <main className="p-4 space-y-4 h-full">
          ...
          {activeTab === 'voice' && (
            <Suspense fallback={<div className="p-4 flex items-center justify-center h-full text-indigo-300/50 animate-pulse font-stencil tracking-widest text-sm">LOADING ROOMS...</div>}>
