...
// Code-split route components to significantly reduce the main bundle size,
// especially for heavy dependencies like VoiceRoomView (Agora SDK)
    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden pb-24">
      ...
      <div className="flex-1 relative z-10 w-full max-w-lg mx-auto">
        ...
        <main className="p-4 space-y-4 h-full">
          <Suspense fallback={<div className="flex items-center justify-center h-full text-indigo-400">Loading...</div>}>
