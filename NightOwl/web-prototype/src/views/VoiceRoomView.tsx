    ...
    <div className="flex flex-col h-full fixed inset-0 z-30 bg-black/40 backdrop-blur-md pb-safe">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        <div>
           ...
           <input type="text" placeholder="深夜の読書会..." value={title} onChange={e => setTitle(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl p-4 outline-none focus:border-indigo-500/50" maxLength={50} />
        </div>
