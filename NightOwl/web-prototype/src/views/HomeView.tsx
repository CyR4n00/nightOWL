...
// ⚡ Bolt: Extracted PostItem and wrapped with React.memo to prevent O(n) cascading re-renders
// of the entire list whenever the parent component state (like inputText) changes.
