    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 flex flex-col gap-3 pb-24">
           ...
           {friends.map(friend => (
            <button key={friend.id} onClick={() => setActiveFriend(friend)} className="w-full text-left glass-panel p-4 flex items-center gap-4 cursor-pointer hover:border-indigo-500/30 transition-all shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-xl">
